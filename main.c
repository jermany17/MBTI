...
char sih_Q[QUESTION_NUM][100] = {
    ...
    "사람들이 많은 곳에 자주 가나요? (Y/N)" //0~2번은 E/I인 경우(Y일 때 E임)
    "상상에 빠져들기 쉬우신가요? (Y/N)",
    "새로운 경험을 추구하는 편인가요? (Y/N)",
    "4차원 같다는 말을 많이 들으시나요? (Y/N)", // 3~5번은 N/S인 경우(Y일 때 N임)
    "타인의 감정에 관심없는 편인가요? (Y/N)",
    "공감해줘라는 말을 많이 듣는 편인가요 (Y/N)",
    "감정보다 이성을 따르는 편인가요? (Y/N)", // 6~8번은 F/T (Y일 때 T임)
    "규칙적인 일상을 선호하시나요? (Y/N)",
    "마감기한을 잘 지키시나요? (Y/N)",
    "휴식을 취하기 전에 집안일을 먼저 끝내시나요? (Y/N) " // 9~11번은 J/P (Y일 때 J임)
